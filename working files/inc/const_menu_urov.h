...
enum _index_ml_ctrl_UROV
{
  ...
  INDEX_ML_CTRUROV_SEL_I,
  INDEX_ML_CTRUROV_STARTED_FROM_OZT1,
  INDEX_ML_CTRUROV_STARTED_FROM_OZT2,
  ...
  INDEX_ML_CTRUROV_STARTED_FROM_GP1,
  INDEX_ML_CTRUROV_STARTED_FROM_GP2,
  INDEX_ML_CTRUROV_STARTED_FROM_GP_RPN,
  INDEX_ML_CTRUROV_STARTED_FROM_TP,
  INDEX_ML_CTRUROV_STARTED_FROM_UP1,

  MAX_ROW_FOR_CONTROL_UROV = (INDEX_ML_CTRUROV_STARTED_FROM_UP1 + NUMBER_UP)
};

#define CTR_UROV_MASKA                   0xffffffff
