...
#define EKRAN_SETPOINT_UROV_GROUP1 (EKRAN_SETPOINT_TZNP_GROUP4 + 1)
...
#define EKRAN_TIMEOUT_UROV_GROUP1  (EKRAN_TIMEOUT_TZNP_GROUP4  + 1)
...
#define EKRAN_CONTROL_UROV         (EKRAN_CONTROL_TZNP         + 1)
