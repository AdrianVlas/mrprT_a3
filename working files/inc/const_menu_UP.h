...
#define EKRAN_SETPOINT_UP_GROUP1   (EKRAN_SETPOINT_KZ_ZV_GROUP4 + 1)
...
#define EKRAN_TIMEOUT_UP_GROUP1    (EKRAN_TIMEOUT_GZ_GROUP4 + 1)
...
#define EKRAN_CONTROL_UP           (EKRAN_CONTROL_GZ  + 1)
