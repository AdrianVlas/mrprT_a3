...
#define EKRAN_TIMEOUT_SWITCH           (EKRAN_CHOOSE_SETTINGS_SWITCHER  + 1)
#define EKRAN_CONTROL_SWITCH           (EKRAN_TIMEOUT_SWITCH  + 1)
#define EKRAN_CHOOSE_RANG_SWITCH       (EKRAN_CONTROL_SWITCH  + 1)
#define EKRAN_RANGUVANNJA_OFF_CB_H       (EKRAN_CHOOSE_RANG_SWITCH + 1) 
#define EKRAN_RANGUVANNJA_ON_CB_H        (EKRAN_RANGUVANNJA_OFF_CB_H + 1) 
#define EKRAN_RANGUVANNJA_OFF_CB_L       (EKRAN_RANGUVANNJA_ON_CB_H + 1) 
#define EKRAN_RANGUVANNJA_ON_CB_L        (EKRAN_RANGUVANNJA_OFF_CB_L + 1) 
