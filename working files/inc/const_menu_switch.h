...
#define EKRAN_TIMEOUT_SWITCH_HV           (EKRAN_CHOOSE_SETTINGS_SWITCHER_LV  + 1)
#define EKRAN_TIMEOUT_SWITCH_LV           (EKRAN_TIMEOUT_SWITCH_HV  + 1)
#define EKRAN_CONTROL_SWITCH_HV           (EKRAN_TIMEOUT_SWITCH_LV  + 1)
#define EKRAN_CONTROL_SWITCH_LV           (EKRAN_CONTROL_SWITCH_HV  + 1)
#define EKRAN_CHOOSE_RANG_SWITCH_HV       (EKRAN_CONTROL_SWITCH_LV  + 1)
#define EKRAN_CHOOSE_RANG_SWITCH_LV       (EKRAN_CHOOSE_RANG_SWITCH_HV  + 1)
#define EKRAN_RANGUVANNJA_OFF_CB_HV       (EKRAN_CHOOSE_RANG_SWITCH_LV + 1) 
#define EKRAN_RANGUVANNJA_OFF_CB_LV       (EKRAN_RANGUVANNJA_OFF_CB_HV + 1) 
#define EKRAN_RANGUVANNJA_ON_CB_HV        (EKRAN_RANGUVANNJA_OFF_CB_LV + 1) 
#define EKRAN_RANGUVANNJA_ON_CB_LV        (EKRAN_RANGUVANNJA_ON_CB_HV + 1) 
