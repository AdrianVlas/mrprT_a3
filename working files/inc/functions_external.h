...
extern void make_ekran_measurement_voltage_type(void);
extern void make_ekran_measurement_current_type(void);
extern void make_ekran_current_phase(unsigned int);
extern void make_ekran_current_given(unsigned int);
extern void make_ekran_current_diff(unsigned int);
extern void make_ekran_current_sklad(unsigned int);
extern void make_ekran_voltage_phase(unsigned int);
extern void make_ekran_voltage_line(unsigned int);
extern void make_ekran_voltage_sklad(unsigned int);
...
extern void make_ekran_setpoint_ozt(unsigned int);
extern void make_ekran_timeout_ozt(unsigned int);
extern void make_ekran_control_ozt(void);
...
extern int  findMenuListIndex_control_mtz(int ekranListIndex);
extern int  findEkranListIndex_control_mtz(int menuListIndex);
extern int  findEkranListSize_control_mtz(void);
extern int  corelCTRMTZ_1_SEL_I(void);
extern int  corelCTRMTZ_2_SEL_I(void);
extern int  corelCTRMTZ_3_SEL_I(void);
extern int  corelCTRMTZ_4_SEL_I(void);
extern int  normalizEkranIndex_control_mtz(void);
...
extern void make_ekran_setpoint_urov(uint32_t, unsigned int);
extern void make_ekran_timeout_urov(uint32_t, unsigned int);
extern void make_ekran_control_urov(uint32_t);
extern int  findMenuListIndex_control_urov(int ekranListIndex);
extern int  findEkranListIndex_control_urov(int menuListIndex);
extern int  findEkranListSize_control_urov(void);
extern int  normalizEkranIndex_control_urov(void);
...
extern void make_ekran_setpoint_kz_zp(unsigned int);
extern void make_ekran_control_kz_zp(void);
...
extern void make_ekran_chose_of_inputs_outputs_leds_df_buttons_for_ranguvannja(__id_list);
...
extern void make_ekran_choose_CBOn_CBOff(uint32_t);
extern void make_ekran_timeout_switch(uint32_t);
extern void make_ekran_control_switch(uint32_t);
...
extern void action_after_changing_ctrl_transformator(__SETTINGS *, uint32_t);
...
extern void ozt_handler(unsigned int*, unsigned int);
...
extern void control_2VV(unsigned int *p_active_functions);
...
extern void calc_power_total(void);
