...
#define EKRAN_SETPOINT_MTZ_GROUP1   (EKRAN_SETPOINT_OZT_GROUP4 + 1)
...
#define EKRAN_TIMEOUT_MTZ_GROUP1    (EKRAN_TIMEOUT_OZT_GROUP4 + 1)
...
#define EKRAN_CONTROL_MTZ           (EKRAN_CONTROL_OZT + 1)
