...
//поиск активного бита
  ...
  {
   case 0:
    ranguvannja_vv = &current_settings_interfaces.ranguvannja_on_cb[0][0]; 
   break;
   case 1:
    ranguvannja_vv = &current_settings_interfaces.ranguvannja_off_cb[0][0]; 
   break;
   case 2:
    ranguvannja_vv = &current_settings_interfaces.ranguvannja_on_cb[1][0]; 
   break;
   case 3:
    ranguvannja_vv = &current_settings_interfaces.ranguvannja_off_cb[1][0]; 
   break;
  }//switch
  ...
  for(int i=0; i<countAdr; i++)
    {
      ...
      switch((offset/REGISTERS_VV)==1)
      {
       ...
       break;
       case 2:
         ranguvannja_vv = &edition_settings.ranguvannja_on_cb[1][0]; //Ранжування 
       break;
       case 3:
         ranguvannja_vv = &edition_settings.ranguvannja_off_cb[1][0]; //Ранжування 
       break;
      }//switch
