...
void make_ekran_vidkluchenja(void)
{
  ...
  {
    {"   ОЗТ1", "   ОЗТ2", "   МТЗ1", "   МТЗ2", "   МТЗ3", "   МТЗ4", "  3U0-1", "  ТЗНП1", "  ТЗНП2", "  ТЗНП3", "  ТЗНП4", "УРОВ1_1", "УРОВ1_2", "УРОВ2_1", "УРОВ2_2", "   ЗОП1", "   ЗОП2", " ЗНмин1", " ЗНмин2", "ЗНмакc1", "ЗНмакc2", "    ГЗ1", "    ГЗ2", " ГЗ-РПН", "     ТЗ", "    УЗx", " Другие"},
    {"   ОЗТ1", "   ОЗТ2", "   МCЗ1", "   МCЗ2", "   МCЗ3", "   МCЗ4", "  3U0-1", "  СЗНП1", "  СЗНП2", "  СЗНП3", "  СЗНП4", "ПРВВ1_1", "ПРВВ1_2", "ПРВВ2_1", "ПРВВ2_2", "   ЗЗП1", "   ЗЗП2", " ЗНмін1", " ЗНмін2", "ЗНмакc1", "ЗНмакc2", "    ГЗ1", "    ГЗ2", " ГЗ-РПН", "     ТЗ", "    УЗx", "   Інші"},
    {"   OZT1", "   OZT2", "   OCP1", "   OCP2", "   OCP3", "   OCP4", "  3U0-1", "  ТЗНП1", "  ТЗНП2", "  ТЗНП3", "  ТЗНП4", "CBFP1_1", "CBFP1_2", "CBFP2_1", "CBFP2_2", "  NPSP1", "  NPSP2", "  Umin1", "  Umin2", "  Umax1", "  Umax2", "    GP1", "    GP2", " GP-RPN", "     TP", "    УЗx", "  Other"},
    {"   ОЗТ1", "   ОЗТ2", "   МТЗ1", "   МТЗ2", "   МТЗ3", "   МТЗ4", "  3U0-1", "  ТЗНП1", "  ТЗНП2", "  ТЗНП3", "  ТЗНП4", "УРОВ1_1", "УРОВ1_2", "УРОВ2_1", "УРОВ2_2", "   ЗОП1", "   ЗОП2", " ЗНмин1", " ЗНмин2", "ЗНмакc1", "ЗНмакc2", "    ГЗ1", "    ГЗ2", " ГЗ-РПН", "     ТЗ", "    УЗx", " Другие"}
  };
