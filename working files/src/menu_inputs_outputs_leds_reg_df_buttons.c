...
void make_ekran_chose_of_inputs_outputs_leds_df_buttons_for_ranguvannja(__id_list type_of_window)
{
  ...
  {
    {" Двх.           ", " Двых.          ", " Св             ", " О-функция      ", " F              ", " О-триггер      ", " О-И            ", " О-ИЛИ          ", " О-Искл.ИЛИ     ", " О-НЕ           ", " Пер.ф.         ", " УРОВ           ", " Выключатель(x) "},
    {" Двх.           ", " Двих.          ", " Св             ", " В-функція      ", " F              ", " В-триґер       ", " В-І            ", " В-АБО          ", " В-Викл.АБО     ", " В-НЕ           ", " Пер.ф.         ", " ПРВВ           ", " Вимикач(x)     "},
    {" DI.            ", " DO.            ", " LED            ", " UD Function    ", " F              ", " UD Flip-Flop   ", " UD AND         ", " UD OR          ", " UD XOR         ", " UD NOT         ", " Tr.F.          ", " CBFP           ", " CB(x)          "},
    {" Двх.           ", " Двых.          ", " Св             ", " О-функция      ", " F              ", " О-триггер      ", " О-И            ", " О-ИЛИ          ", " О-Искл.ИЛИ     ", " О-НЕ           ", " Пер.ф.         ", " УРОВ           ", " Выключатель(x) "}
  };

  const unsigned int first_index_number[MAX_NAMBER_LANGUAGE][MAX_NUMBER_IN_ID_LIST] = 
  {
    {5, 6, 3, 10, 2, 10, 4, 6, 11, 5, 7, 5, 13},
    {5, 6, 3, 10, 2,  9, 4, 6, 11, 5, 7, 5,  9},
    {4, 4, 4, 12, 2, 13, 7, 6,  7, 6, 6, 5,  4},
    {5, 6, 3, 10, 2, 10, 4, 6, 11, 5, 7, 5, 13}
  };
    ...
    {
      {
       ...
       (NUMBER_GENERAL_SIGNAL_FOR_RANG_SMALL + NUMBER_OFF_ON_SIGNAL_FOR_RANG_SMALL - 1)
      },
      {
       (NUMBER_GENERAL_SIGNAL_FOR_RANG_SMALL + NUMBER_OFF_ON_SIGNAL_FOR_RANG_SMALL),
       (NUMBER_GENERAL_SIGNAL_FOR_RANG_SMALL + NUMBER_OFF_ON_SIGNAL_FOR_RANG_SMALL + NUMBER_OZT_SIGNAL_FOR_RANG_SMALL - 1)
      },
      {
       (NUMBER_GENERAL_SIGNAL_FOR_RANG_SMALL + NUMBER_OFF_ON_SIGNAL_FOR_RANG_SMALL + NUMBER_OZT_SIGNAL_FOR_RANG_SMALL),
       (NUMBER_GENERAL_SIGNAL_FOR_RANG_SMALL + NUMBER_OFF_ON_SIGNAL_FOR_RANG_SMALL + NUMBER_OZT_SIGNAL_FOR_RANG_SMALL + NUMBER_MTZ_SIGNAL_FOR_RANG_SMALL - 1)
      },
      {
       (NUMBER_GENERAL_SIGNAL_FOR_RANG_SMALL + NUMBER_OFF_ON_SIGNAL_FOR_RANG_SMALL + NUMBER_OZT_SIGNAL_FOR_RANG_SMALL + NUMBER_MTZ_SIGNAL_FOR_RANG_SMALL),
       (NUMBER_GENERAL_SIGNAL_FOR_RANG_SMALL + NUMBER_OFF_ON_SIGNAL_FOR_RANG_SMALL + NUMBER_OZT_SIGNAL_FOR_RANG_SMALL + NUMBER_MTZ_SIGNAL_FOR_RANG_SMALL + NUMBER_P_3U0_SIGNAL_FOR_RANG_SMALL - 1)
      },
      {
       (NUMBER_GENERAL_SIGNAL_FOR_RANG_SMALL + NUMBER_OFF_ON_SIGNAL_FOR_RANG_SMALL + NUMBER_OZT_SIGNAL_FOR_RANG_SMALL + NUMBER_MTZ_SIGNAL_FOR_RANG_SMALL + NUMBER_P_3U0_SIGNAL_FOR_RANG_SMALL),
       (NUMBER_GENERAL_SIGNAL_FOR_RANG_SMALL + NUMBER_OFF_ON_SIGNAL_FOR_RANG_SMALL + NUMBER_OZT_SIGNAL_FOR_RANG_SMALL + NUMBER_MTZ_SIGNAL_FOR_RANG_SMALL + NUMBER_P_3U0_SIGNAL_FOR_RANG_SMALL + NUMBER_TZNP_SIGNAL_FOR_RANG_SMALL - 1)
      },
      {
       (NUMBER_GENERAL_SIGNAL_FOR_RANG_SMALL + NUMBER_OFF_ON_SIGNAL_FOR_RANG_SMALL + NUMBER_OZT_SIGNAL_FOR_RANG_SMALL + NUMBER_MTZ_SIGNAL_FOR_RANG_SMALL + NUMBER_P_3U0_SIGNAL_FOR_RANG_SMALL + NUMBER_TZNP_SIGNAL_FOR_RANG_SMALL),
       (NUMBER_GENERAL_SIGNAL_FOR_RANG_SMALL + NUMBER_OFF_ON_SIGNAL_FOR_RANG_SMALL + NUMBER_OZT_SIGNAL_FOR_RANG_SMALL + NUMBER_MTZ_SIGNAL_FOR_RANG_SMALL + NUMBER_P_3U0_SIGNAL_FOR_RANG_SMALL + NUMBER_TZNP_SIGNAL_FOR_RANG_SMALL  + NUMBER_UROV_SIGNAL_FOR_RANG_SMALL - 1)
      },
      {
       (NUMBER_GENERAL_SIGNAL_FOR_RANG_SMALL + NUMBER_OFF_ON_SIGNAL_FOR_RANG_SMALL + NUMBER_OZT_SIGNAL_FOR_RANG_SMALL + NUMBER_MTZ_SIGNAL_FOR_RANG_SMALL + NUMBER_P_3U0_SIGNAL_FOR_RANG_SMALL + NUMBER_TZNP_SIGNAL_FOR_RANG_SMALL  + NUMBER_UROV_SIGNAL_FOR_RANG_SMALL),
       (NUMBER_GENERAL_SIGNAL_FOR_RANG_SMALL + NUMBER_OFF_ON_SIGNAL_FOR_RANG_SMALL + NUMBER_OZT_SIGNAL_FOR_RANG_SMALL + NUMBER_MTZ_SIGNAL_FOR_RANG_SMALL + NUMBER_P_3U0_SIGNAL_FOR_RANG_SMALL + NUMBER_TZNP_SIGNAL_FOR_RANG_SMALL  + NUMBER_UROV_SIGNAL_FOR_RANG_SMALL + NUMBER_ZOP_SIGNAL_FOR_RANG_SMALL - 1)
      },
      {
       (NUMBER_GENERAL_SIGNAL_FOR_RANG_SMALL + NUMBER_OFF_ON_SIGNAL_FOR_RANG_SMALL + NUMBER_OZT_SIGNAL_FOR_RANG_SMALL + NUMBER_MTZ_SIGNAL_FOR_RANG_SMALL + NUMBER_P_3U0_SIGNAL_FOR_RANG_SMALL + NUMBER_TZNP_SIGNAL_FOR_RANG_SMALL  + NUMBER_UROV_SIGNAL_FOR_RANG_SMALL + NUMBER_ZOP_SIGNAL_FOR_RANG_SMALL),
      ...
      },
      {
       ...
       (NUMBER_GENERAL_SIGNAL_FOR_RANG_SMALL + NUMBER_OFF_ON_SIGNAL_FOR_RANG_SMALL + NUMBER_OZT_SIGNAL_FOR_RANG_SMALL + NUMBER_MTZ_SIGNAL_FOR_RANG_SMALL + NUMBER_P_3U0_SIGNAL_FOR_RANG_SMALL + NUMBER_TZNP_SIGNAL_FOR_RANG_SMALL  + NUMBER_UROV_SIGNAL_FOR_RANG_SMALL + NUMBER_ZOP_SIGNAL_FOR_RANG_SMALL + NUMBER_UMIN_SIGNAL_FOR_RANG_SMALL + NUMBER_UMAX_SIGNAL_FOR_RANG_SMALL + NUMBER_KZ_ZV_SIGNAL_FOR_RANG_SMALL - 1)
      },
      {
      ...
      {
       (NUMBER_GENERAL_SIGNAL_FOR_RANG_SMALL + NUMBER_OFF_ON_SIGNAL_FOR_RANG_SMALL + NUMBER_OZT_SIGNAL_FOR_RANG_SMALL + NUMBER_MTZ_SIGNAL_FOR_RANG_SMALL + NUMBER_P_3U0_SIGNAL_FOR_RANG_SMALL + NUMBER_TZNP_SIGNAL_FOR_RANG_SMALL  + NUMBER_UROV_SIGNAL_FOR_RANG_SMALL + NUMBER_ZOP_SIGNAL_FOR_RANG_SMALL + NUMBER_UMIN_SIGNAL_FOR_RANG_SMALL + NUMBER_UMAX_SIGNAL_FOR_RANG_SMALL + NUMBER_KZ_ZV_SIGNAL_FOR_RANG_SMALL + NUMBER_GP_SIGNAL_FOR_RANG_SMALL),
       (NUMBER_GENERAL_SIGNAL_FOR_RANG_SMALL + NUMBER_OFF_ON_SIGNAL_FOR_RANG_SMALL + NUMBER_OZT_SIGNAL_FOR_RANG_SMALL + NUMBER_MTZ_SIGNAL_FOR_RANG_SMALL + NUMBER_P_3U0_SIGNAL_FOR_RANG_SMALL + NUMBER_TZNP_SIGNAL_FOR_RANG_SMALL  + NUMBER_UROV_SIGNAL_FOR_RANG_SMALL + NUMBER_ZOP_SIGNAL_FOR_RANG_SMALL + NUMBER_UMIN_SIGNAL_FOR_RANG_SMALL + NUMBER_UMAX_SIGNAL_FOR_RANG_SMALL + NUMBER_KZ_ZV_SIGNAL_FOR_RANG_SMALL + NUMBER_GP_SIGNAL_FOR_RANG_SMALL + NUMBER_TP_SIGNAL_FOR_RANG_SMALL - 1)
      },
      {
       (NUMBER_GENERAL_SIGNAL_FOR_RANG_SMALL + NUMBER_OFF_ON_SIGNAL_FOR_RANG_SMALL + NUMBER_OZT_SIGNAL_FOR_RANG_SMALL + NUMBER_MTZ_SIGNAL_FOR_RANG_SMALL + NUMBER_P_3U0_SIGNAL_FOR_RANG_SMALL + NUMBER_TZNP_SIGNAL_FOR_RANG_SMALL  + NUMBER_UROV_SIGNAL_FOR_RANG_SMALL + NUMBER_ZOP_SIGNAL_FOR_RANG_SMALL + NUMBER_UMIN_SIGNAL_FOR_RANG_SMALL + NUMBER_UMAX_SIGNAL_FOR_RANG_SMALL + NUMBER_KZ_ZV_SIGNAL_FOR_RANG_SMALL + NUMBER_GP_SIGNAL_FOR_RANG_SMALL + NUMBER_TP_SIGNAL_FOR_RANG_SMALL),
       (NUMBER_GENERAL_SIGNAL_FOR_RANG_SMALL + NUMBER_OFF_ON_SIGNAL_FOR_RANG_SMALL + NUMBER_OZT_SIGNAL_FOR_RANG_SMALL + NUMBER_MTZ_SIGNAL_FOR_RANG_SMALL + NUMBER_P_3U0_SIGNAL_FOR_RANG_SMALL + NUMBER_TZNP_SIGNAL_FOR_RANG_SMALL  + NUMBER_UROV_SIGNAL_FOR_RANG_SMALL + NUMBER_ZOP_SIGNAL_FOR_RANG_SMALL + NUMBER_UMIN_SIGNAL_FOR_RANG_SMALL + NUMBER_UMAX_SIGNAL_FOR_RANG_SMALL + NUMBER_KZ_ZV_SIGNAL_FOR_RANG_SMALL + NUMBER_GP_SIGNAL_FOR_RANG_SMALL + NUMBER_TP_SIGNAL_FOR_RANG_SMALL + NUMBER_UP_SIGNAL_FOR_RANG_SMALL - 1)
      },
      {
       (NUMBER_GENERAL_SIGNAL_FOR_RANG_SMALL + NUMBER_OFF_ON_SIGNAL_FOR_RANG_SMALL + NUMBER_OZT_SIGNAL_FOR_RANG_SMALL + NUMBER_MTZ_SIGNAL_FOR_RANG_SMALL + NUMBER_P_3U0_SIGNAL_FOR_RANG_SMALL + NUMBER_TZNP_SIGNAL_FOR_RANG_SMALL + NUMBER_UROV_SIGNAL_FOR_RANG_SMALL + NUMBER_ZOP_SIGNAL_FOR_RANG_SMALL + NUMBER_UMIN_SIGNAL_FOR_RANG_SMALL + NUMBER_UMAX_SIGNAL_FOR_RANG_SMALL + NUMBER_KZ_ZV_SIGNAL_FOR_RANG_SMALL + NUMBER_GP_SIGNAL_FOR_RANG_SMALL + NUMBER_TP_SIGNAL_FOR_RANG_SMALL + NUMBER_UP_SIGNAL_FOR_RANG_SMALL),
       (NUMBER_GENERAL_SIGNAL_FOR_RANG_SMALL + NUMBER_OFF_ON_SIGNAL_FOR_RANG_SMALL + NUMBER_OZT_SIGNAL_FOR_RANG_SMALL + NUMBER_MTZ_SIGNAL_FOR_RANG_SMALL + NUMBER_P_3U0_SIGNAL_FOR_RANG_SMALL + NUMBER_TZNP_SIGNAL_FOR_RANG_SMALL + NUMBER_UROV_SIGNAL_FOR_RANG_SMALL + NUMBER_ZOP_SIGNAL_FOR_RANG_SMALL + NUMBER_UMIN_SIGNAL_FOR_RANG_SMALL + NUMBER_UMAX_SIGNAL_FOR_RANG_SMALL + NUMBER_KZ_ZV_SIGNAL_FOR_RANG_SMALL + NUMBER_GP_SIGNAL_FOR_RANG_SMALL + NUMBER_TP_SIGNAL_FOR_RANG_SMALL + NUMBER_UP_SIGNAL_FOR_RANG_SMALL + NUMBER_EL_SIGNAL_FOR_RANG_SMALL - 1)
      }
    };
  ...
  else
  {
    ...
    {
      {
       ...
       (NUMBER_GENERAL_SIGNAL_FOR_RANG + NUMBER_OFF_ON_SIGNAL_FOR_RANG - 1)
      },
      {
       (NUMBER_GENERAL_SIGNAL_FOR_RANG + NUMBER_OFF_ON_SIGNAL_FOR_RANG),
       (NUMBER_GENERAL_SIGNAL_FOR_RANG + NUMBER_OFF_ON_SIGNAL_FOR_RANG + NUMBER_OZT_SIGNAL_FOR_RANG - 1)
      },
      {
       (NUMBER_GENERAL_SIGNAL_FOR_RANG + NUMBER_OFF_ON_SIGNAL_FOR_RANG + NUMBER_OZT_SIGNAL_FOR_RANG),
       (NUMBER_GENERAL_SIGNAL_FOR_RANG + NUMBER_OFF_ON_SIGNAL_FOR_RANG + NUMBER_OZT_SIGNAL_FOR_RANG + NUMBER_MTZ_SIGNAL_FOR_RANG - 1)
      },
      {
       (NUMBER_GENERAL_SIGNAL_FOR_RANG + NUMBER_OFF_ON_SIGNAL_FOR_RANG + NUMBER_OZT_SIGNAL_FOR_RANG + NUMBER_MTZ_SIGNAL_FOR_RANG),
       (NUMBER_GENERAL_SIGNAL_FOR_RANG + NUMBER_OFF_ON_SIGNAL_FOR_RANG + NUMBER_OZT_SIGNAL_FOR_RANG + NUMBER_MTZ_SIGNAL_FOR_RANG + NUMBER_P_3U0_SIGNAL_FOR_RANG - 1)
      },
      {
       (NUMBER_GENERAL_SIGNAL_FOR_RANG + NUMBER_OFF_ON_SIGNAL_FOR_RANG + NUMBER_OZT_SIGNAL_FOR_RANG + NUMBER_MTZ_SIGNAL_FOR_RANG + NUMBER_P_3U0_SIGNAL_FOR_RANG),
       (NUMBER_GENERAL_SIGNAL_FOR_RANG + NUMBER_OFF_ON_SIGNAL_FOR_RANG + NUMBER_OZT_SIGNAL_FOR_RANG + NUMBER_MTZ_SIGNAL_FOR_RANG + NUMBER_P_3U0_SIGNAL_FOR_RANG + NUMBER_TZNP_SIGNAL_FOR_RANG - 1)
      },
      {
       (NUMBER_GENERAL_SIGNAL_FOR_RANG + NUMBER_OFF_ON_SIGNAL_FOR_RANG + NUMBER_OZT_SIGNAL_FOR_RANG + NUMBER_MTZ_SIGNAL_FOR_RANG + NUMBER_P_3U0_SIGNAL_FOR_RANG + NUMBER_TZNP_SIGNAL_FOR_RANG),
       (NUMBER_GENERAL_SIGNAL_FOR_RANG + NUMBER_OFF_ON_SIGNAL_FOR_RANG + NUMBER_OZT_SIGNAL_FOR_RANG + NUMBER_MTZ_SIGNAL_FOR_RANG + NUMBER_P_3U0_SIGNAL_FOR_RANG + NUMBER_TZNP_SIGNAL_FOR_RANG  + NUMBER_UROV_SIGNAL_FOR_RANG - 1)
      },
      {
       (NUMBER_GENERAL_SIGNAL_FOR_RANG + NUMBER_OFF_ON_SIGNAL_FOR_RANG + NUMBER_OZT_SIGNAL_FOR_RANG + NUMBER_MTZ_SIGNAL_FOR_RANG + NUMBER_P_3U0_SIGNAL_FOR_RANG + NUMBER_TZNP_SIGNAL_FOR_RANG  + NUMBER_UROV_SIGNAL_FOR_RANG),
       (NUMBER_GENERAL_SIGNAL_FOR_RANG + NUMBER_OFF_ON_SIGNAL_FOR_RANG + NUMBER_OZT_SIGNAL_FOR_RANG + NUMBER_MTZ_SIGNAL_FOR_RANG + NUMBER_P_3U0_SIGNAL_FOR_RANG + NUMBER_TZNP_SIGNAL_FOR_RANG  + NUMBER_UROV_SIGNAL_FOR_RANG + NUMBER_ZOP_SIGNAL_FOR_RANG - 1)
      },
      {
       (NUMBER_GENERAL_SIGNAL_FOR_RANG + NUMBER_OFF_ON_SIGNAL_FOR_RANG + NUMBER_OZT_SIGNAL_FOR_RANG + NUMBER_MTZ_SIGNAL_FOR_RANG + NUMBER_P_3U0_SIGNAL_FOR_RANG + NUMBER_TZNP_SIGNAL_FOR_RANG  + NUMBER_UROV_SIGNAL_FOR_RANG + NUMBER_ZOP_SIGNAL_FOR_RANG),
       (NUMBER_GENERAL_SIGNAL_FOR_RANG + NUMBER_OFF_ON_SIGNAL_FOR_RANG + NUMBER_OZT_SIGNAL_FOR_RANG + NUMBER_MTZ_SIGNAL_FOR_RANG + NUMBER_P_3U0_SIGNAL_FOR_RANG + NUMBER_TZNP_SIGNAL_FOR_RANG  + NUMBER_UROV_SIGNAL_FOR_RANG + NUMBER_ZOP_SIGNAL_FOR_RANG + NUMBER_UMIN_SIGNAL_FOR_RANG - 1)
      },
      {
       (NUMBER_GENERAL_SIGNAL_FOR_RANG + NUMBER_OFF_ON_SIGNAL_FOR_RANG + NUMBER_OZT_SIGNAL_FOR_RANG + NUMBER_MTZ_SIGNAL_FOR_RANG + NUMBER_P_3U0_SIGNAL_FOR_RANG + NUMBER_TZNP_SIGNAL_FOR_RANG  + NUMBER_UROV_SIGNAL_FOR_RANG + NUMBER_ZOP_SIGNAL_FOR_RANG + NUMBER_UMIN_SIGNAL_FOR_RANG),
       (NUMBER_GENERAL_SIGNAL_FOR_RANG + NUMBER_OFF_ON_SIGNAL_FOR_RANG + NUMBER_OZT_SIGNAL_FOR_RANG + NUMBER_MTZ_SIGNAL_FOR_RANG + NUMBER_P_3U0_SIGNAL_FOR_RANG + NUMBER_TZNP_SIGNAL_FOR_RANG  + NUMBER_UROV_SIGNAL_FOR_RANG + NUMBER_ZOP_SIGNAL_FOR_RANG + NUMBER_UMIN_SIGNAL_FOR_RANG + NUMBER_UMAX_SIGNAL_FOR_RANG - 1)
      },
      {
       (NUMBER_GENERAL_SIGNAL_FOR_RANG + NUMBER_OFF_ON_SIGNAL_FOR_RANG + NUMBER_OZT_SIGNAL_FOR_RANG + NUMBER_MTZ_SIGNAL_FOR_RANG + NUMBER_P_3U0_SIGNAL_FOR_RANG + NUMBER_TZNP_SIGNAL_FOR_RANG  + NUMBER_UROV_SIGNAL_FOR_RANG + NUMBER_ZOP_SIGNAL_FOR_RANG + NUMBER_UMIN_SIGNAL_FOR_RANG + NUMBER_UMAX_SIGNAL_FOR_RANG),
       (NUMBER_GENERAL_SIGNAL_FOR_RANG + NUMBER_OFF_ON_SIGNAL_FOR_RANG + NUMBER_OZT_SIGNAL_FOR_RANG + NUMBER_MTZ_SIGNAL_FOR_RANG + NUMBER_P_3U0_SIGNAL_FOR_RANG + NUMBER_TZNP_SIGNAL_FOR_RANG  + NUMBER_UROV_SIGNAL_FOR_RANG + NUMBER_ZOP_SIGNAL_FOR_RANG + NUMBER_UMIN_SIGNAL_FOR_RANG + NUMBER_UMAX_SIGNAL_FOR_RANG + NUMBER_KZ_ZV_SIGNAL_FOR_RANG - 1)
      },
      {
       (NUMBER_GENERAL_SIGNAL_FOR_RANG + NUMBER_OFF_ON_SIGNAL_FOR_RANG + NUMBER_OZT_SIGNAL_FOR_RANG + NUMBER_MTZ_SIGNAL_FOR_RANG + NUMBER_P_3U0_SIGNAL_FOR_RANG + NUMBER_TZNP_SIGNAL_FOR_RANG  + NUMBER_UROV_SIGNAL_FOR_RANG + NUMBER_ZOP_SIGNAL_FOR_RANG + NUMBER_UMIN_SIGNAL_FOR_RANG + NUMBER_UMAX_SIGNAL_FOR_RANG + NUMBER_KZ_ZV_SIGNAL_FOR_RANG),
       (NUMBER_GENERAL_SIGNAL_FOR_RANG + NUMBER_OFF_ON_SIGNAL_FOR_RANG + NUMBER_OZT_SIGNAL_FOR_RANG + NUMBER_MTZ_SIGNAL_FOR_RANG + NUMBER_P_3U0_SIGNAL_FOR_RANG + NUMBER_TZNP_SIGNAL_FOR_RANG  + NUMBER_UROV_SIGNAL_FOR_RANG + NUMBER_ZOP_SIGNAL_FOR_RANG + NUMBER_UMIN_SIGNAL_FOR_RANG + NUMBER_UMAX_SIGNAL_FOR_RANG + NUMBER_KZ_ZV_SIGNAL_FOR_RANG + NUMBER_GP_SIGNAL_FOR_RANG - 1)
      },
      {
       (NUMBER_GENERAL_SIGNAL_FOR_RANG + NUMBER_OFF_ON_SIGNAL_FOR_RANG + NUMBER_OZT_SIGNAL_FOR_RANG + NUMBER_MTZ_SIGNAL_FOR_RANG + NUMBER_P_3U0_SIGNAL_FOR_RANG + NUMBER_TZNP_SIGNAL_FOR_RANG  + NUMBER_UROV_SIGNAL_FOR_RANG + NUMBER_ZOP_SIGNAL_FOR_RANG + NUMBER_UMIN_SIGNAL_FOR_RANG + NUMBER_UMAX_SIGNAL_FOR_RANG + NUMBER_KZ_ZV_SIGNAL_FOR_RANG + NUMBER_GP_SIGNAL_FOR_RANG),
       (NUMBER_GENERAL_SIGNAL_FOR_RANG + NUMBER_OFF_ON_SIGNAL_FOR_RANG + NUMBER_OZT_SIGNAL_FOR_RANG + NUMBER_MTZ_SIGNAL_FOR_RANG + NUMBER_P_3U0_SIGNAL_FOR_RANG + NUMBER_TZNP_SIGNAL_FOR_RANG  + NUMBER_UROV_SIGNAL_FOR_RANG + NUMBER_ZOP_SIGNAL_FOR_RANG + NUMBER_UMIN_SIGNAL_FOR_RANG + NUMBER_UMAX_SIGNAL_FOR_RANG + NUMBER_KZ_ZV_SIGNAL_FOR_RANG + NUMBER_GP_SIGNAL_FOR_RANG + NUMBER_TP_SIGNAL_FOR_RANG - 1)
      },
      {
       (NUMBER_GENERAL_SIGNAL_FOR_RANG + NUMBER_OFF_ON_SIGNAL_FOR_RANG + NUMBER_OZT_SIGNAL_FOR_RANG + NUMBER_MTZ_SIGNAL_FOR_RANG + NUMBER_P_3U0_SIGNAL_FOR_RANG + NUMBER_TZNP_SIGNAL_FOR_RANG  + NUMBER_UROV_SIGNAL_FOR_RANG + NUMBER_ZOP_SIGNAL_FOR_RANG + NUMBER_UMIN_SIGNAL_FOR_RANG + NUMBER_UMAX_SIGNAL_FOR_RANG + NUMBER_KZ_ZV_SIGNAL_FOR_RANG + NUMBER_GP_SIGNAL_FOR_RANG + NUMBER_TP_SIGNAL_FOR_RANG),
       (NUMBER_GENERAL_SIGNAL_FOR_RANG + NUMBER_OFF_ON_SIGNAL_FOR_RANG + NUMBER_OZT_SIGNAL_FOR_RANG + NUMBER_MTZ_SIGNAL_FOR_RANG + NUMBER_P_3U0_SIGNAL_FOR_RANG + NUMBER_TZNP_SIGNAL_FOR_RANG  + NUMBER_UROV_SIGNAL_FOR_RANG + NUMBER_ZOP_SIGNAL_FOR_RANG + NUMBER_UMIN_SIGNAL_FOR_RANG + NUMBER_UMAX_SIGNAL_FOR_RANG + NUMBER_KZ_ZV_SIGNAL_FOR_RANG + NUMBER_GP_SIGNAL_FOR_RANG + NUMBER_TP_SIGNAL_FOR_RANG + NUMBER_UP_SIGNAL_FOR_RANG - 1)
      },
      {
       ...
       (NUMBER_GENERAL_SIGNAL_FOR_RANG + NUMBER_OFF_ON_SIGNAL_FOR_RANG + NUMBER_OZT_SIGNAL_FOR_RANG + NUMBER_MTZ_SIGNAL_FOR_RANG + NUMBER_P_3U0_SIGNAL_FOR_RANG + NUMBER_TZNP_SIGNAL_FOR_RANG + NUMBER_UROV_SIGNAL_FOR_RANG + NUMBER_ZOP_SIGNAL_FOR_RANG + NUMBER_UMIN_SIGNAL_FOR_RANG + NUMBER_UMAX_SIGNAL_FOR_RANG + NUMBER_KZ_ZV_SIGNAL_FOR_RANG + NUMBER_GP_SIGNAL_FOR_RANG + NUMBER_TP_SIGNAL_FOR_RANG + NUMBER_UP_SIGNAL_FOR_RANG + NUMBER_EL_SIGNAL_FOR_RANG - 1)
      }
    };
    ...
    for (i = 0; i < TOTAL_NUMBER_PROTECTION; i++)
    {
      ...
      if((current_settings.configuration & (1 << i)) != 0)
      {
        ...
        if(min_max_number[i][0] >=0)
        {
          if (i == OFF_ON_BIT_CONFIGURATION)
          {
            /*
            Випадок коли деякі сигнали блоків Ввімкнення/Вимкнення треба відфільтрувати
            */
            ...
            {
              if (
                  ((type_ekran == INDEX_VIEWING_OFF_CB_H) && (index_in_list == RANG_WORK_BO_H)) ||
                  ((type_ekran == INDEX_VIEWING_ON_CB_H ) && (index_in_list == RANG_WORK_BV_H)) ||
                  ((type_ekran == INDEX_VIEWING_OFF_CB_L) && (index_in_list == RANG_WORK_BO_L)) ||
                  ((type_ekran == INDEX_VIEWING_ON_CB_L ) && (index_in_list == RANG_WORK_BV_L))
                 )
              {
                /***/
                //Зміщуємо біти стану реанжування функцій разом із їх назвами
                                                        ...
                                                        )
{
  if(plus_minus == 1)
  {
    ...
    {
      if (current_ekran.index_position < (number_general_function + number_on_off_function))
      {
        if ((current_settings.configuration & (1<<OFF_ON_BIT_CONFIGURATION)) != 0) *found_new_index_tmp = 1;
        else current_ekran.index_position = number_general_function + number_on_off_function;
      }
      else if (current_ekran.index_position < (number_general_function + number_on_off_function + number_ozt_function))
      {
        if ((current_settings.configuration & (1<<OZT_BIT_CONFIGURATION)) != 0) *found_new_index_tmp = 1;
        else current_ekran.index_position = number_general_function + number_on_off_function + number_ozt_function;
      }
      else if (current_ekran.index_position < (number_general_function + number_on_off_function + number_ozt_function + number_mtz_function))
      {
        if ((current_settings.configuration & (1<<MTZ_BIT_CONFIGURATION)) != 0) *found_new_index_tmp = 1;
        else current_ekran.index_position = number_general_function + number_on_off_function + number_ozt_function + number_mtz_function;
      }
      else if (current_ekran.index_position < (number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function))
      {
        if ((current_settings.configuration & (1<<P_3U0_BIT_CONFIGURATION)) != 0) *found_new_index_tmp = 1;
        else current_ekran.index_position = number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function;
      }
      else if (current_ekran.index_position < (number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function))
      {
        if ((current_settings.configuration & (1<<TZNP_BIT_CONFIGURATION)) != 0) *found_new_index_tmp = 1;
        else current_ekran.index_position = number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function;
      }
      else if (current_ekran.index_position < (number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function + number_urov_function))
      {
        if ((current_settings.configuration & (1<<UROV_BIT_CONFIGURATION)) != 0) *found_new_index_tmp = 1;
        else current_ekran.index_position = number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function + number_urov_function;
      }
      else if (current_ekran.index_position < (number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function + number_urov_function + number_zop_function))
      {
        if ((current_settings.configuration & (1<<ZOP_BIT_CONFIGURATION)) != 0) *found_new_index_tmp = 1;
        else current_ekran.index_position = number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function + number_urov_function + number_zop_function;
      }
      else if (current_ekran.index_position < (number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function + number_urov_function + number_zop_function + number_Umin_function))
      {
        if ((current_settings.configuration & (1<<UMIN_BIT_CONFIGURATION)) != 0) *found_new_index_tmp = 1;
        else current_ekran.index_position = number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function + number_urov_function + number_zop_function + number_Umin_function;
      }
      else if (current_ekran.index_position < (number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function + number_urov_function + number_zop_function + number_Umin_function + number_Umax_function))
      {
        if ((current_settings.configuration & (1<<UMAX_BIT_CONFIGURATION)) != 0) *found_new_index_tmp = 1;
        else current_ekran.index_position = number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function + number_urov_function + number_zop_function + number_Umin_function + number_Umax_function;
      }
      else if (current_ekran.index_position < (number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function + number_urov_function + number_zop_function + number_Umin_function + number_Umax_function + number_kz_zv_function))
      {
        if ((current_settings.configuration & (1<<KZ_ZV_BIT_CONFIGURATION)) != 0) *found_new_index_tmp = 1;
        else current_ekran.index_position = number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function + number_urov_function + number_zop_function + number_Umin_function + number_Umax_function + number_kz_zv_function;
      }
      else if (current_ekran.index_position < (number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function + number_urov_function + number_zop_function + number_Umin_function + number_Umax_function + number_kz_zv_function + number_GP_function))
      {
        if ((current_settings.configuration & (1<<GP_BIT_CONFIGURATION)) != 0) *found_new_index_tmp = 1;
        else current_ekran.index_position = number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function + number_urov_function + number_zop_function + number_Umin_function + number_Umax_function + number_kz_zv_function + number_GP_function;
      }
      else if (current_ekran.index_position < (number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function + number_urov_function + number_zop_function + number_Umin_function + number_Umax_function + number_kz_zv_function + number_GP_function + number_TP_function))
      {
      ...
      else if (current_ekran.index_position < (number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function + number_urov_function + number_zop_function + number_Umin_function + number_Umax_function + number_kz_zv_function + number_GP_function + number_TP_function + number_UP_function))
      {
        if ((current_settings.configuration & (1<<UP_BIT_CONFIGURATION)) != 0) *found_new_index_tmp = 1;
        else current_ekran.index_position = number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function + number_urov_function + number_zop_function + number_Umin_function + number_Umax_function + number_kz_zv_function + number_GP_function + number_TP_function + number_UP_function;
      }
      else if (current_ekran.index_position < (number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function + number_urov_function + number_zop_function + number_Umin_function + number_Umax_function + number_kz_zv_function + number_GP_function + number_TP_function + number_UP_function + number_el_function))
      {
...
//    }
  ...
  else
  {
    ...
    else
    {
      ...
      {
        if ((current_settings.configuration & (1<<OZT_BIT_CONFIGURATION)) != 0) *found_new_index_tmp = 1;
        else current_ekran.index_position = number_general_function + number_on_off_function - 1;
      }
      else if (current_ekran.index_position < (number_general_function + number_on_off_function + number_ozt_function + number_mtz_function))
      {
        if ((current_settings.configuration & (1<<MTZ_BIT_CONFIGURATION)) != 0) *found_new_index_tmp = 1;
        else current_ekran.index_position = number_general_function + number_on_off_function + number_ozt_function - 1;
      }
      else if (current_ekran.index_position < (number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function))
      {
        if ((current_settings.configuration & (1<<P_3U0_BIT_CONFIGURATION)) != 0) *found_new_index_tmp = 1;
        else current_ekran.index_position = number_general_function + number_on_off_function + number_ozt_function + number_mtz_function - 1;
      }
      else if (current_ekran.index_position < (number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function))
      {
        if ((current_settings.configuration & (1<<TZNP_BIT_CONFIGURATION)) != 0) *found_new_index_tmp = 1;
        else current_ekran.index_position = number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function - 1;
      }
      else if (current_ekran.index_position < (number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function + number_urov_function))
      {
        if ((current_settings.configuration & (1<<UROV_BIT_CONFIGURATION)) != 0) *found_new_index_tmp = 1;
        else current_ekran.index_position = number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function - 1;
      }
      else if (current_ekran.index_position < (number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function + number_urov_function + number_zop_function))
      {
        if ((current_settings.configuration & (1<<ZOP_BIT_CONFIGURATION)) != 0) *found_new_index_tmp = 1;
        else current_ekran.index_position = number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function + number_urov_function - 1;
      }
      else if (current_ekran.index_position < (number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function + number_urov_function + number_zop_function + number_Umin_function))
      {
        if ((current_settings.configuration & (1<<UMIN_BIT_CONFIGURATION)) != 0) *found_new_index_tmp = 1;
        else current_ekran.index_position = number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function + number_urov_function + number_zop_function - 1;
      }
      else if (current_ekran.index_position < (number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function + number_urov_function + number_zop_function + number_Umin_function + number_Umax_function))
      {
        if ((current_settings.configuration & (1<<UMAX_BIT_CONFIGURATION)) != 0) *found_new_index_tmp = 1;
        else current_ekran.index_position = number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function + number_urov_function + number_zop_function + number_Umin_function - 1;
      }
      else if (current_ekran.index_position < (number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function + number_urov_function + number_zop_function + number_Umin_function + number_Umax_function + number_kz_zv_function))
      {
        if ((current_settings.configuration & (1<<KZ_ZV_BIT_CONFIGURATION)) != 0) *found_new_index_tmp = 1;
        else current_ekran.index_position = number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function + number_urov_function + number_zop_function + number_Umin_function + number_Umax_function - 1;
      }
      else if (current_ekran.index_position < (number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function + number_urov_function + number_zop_function + number_Umin_function + number_Umax_function + number_kz_zv_function + number_GP_function))
      {
        if ((current_settings.configuration & (1<<GP_BIT_CONFIGURATION)) != 0) *found_new_index_tmp = 1;
        else current_ekran.index_position = number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function + number_urov_function + number_zop_function + number_Umin_function + number_Umax_function + number_kz_zv_function - 1;
      }
      else if (current_ekran.index_position < (number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function + number_urov_function + number_zop_function + number_Umin_function + number_Umax_function + number_kz_zv_function + number_GP_function + number_TP_function))
      {
        if ((current_settings.configuration & (1<<TP_BIT_CONFIGURATION)) != 0) *found_new_index_tmp = 1;
        else current_ekran.index_position = number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function + number_urov_function + number_zop_function + number_Umin_function + number_Umax_function + number_kz_zv_function + number_GP_function - 1;
      }
      else if (current_ekran.index_position < (number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function + number_urov_function + number_zop_function + number_Umin_function + number_Umax_function + number_kz_zv_function + number_GP_function + number_TP_function + number_UP_function))
      {
        if ((current_settings.configuration & (1<<UP_BIT_CONFIGURATION)) != 0) *found_new_index_tmp = 1;
        else current_ekran.index_position = number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function + number_urov_function + number_zop_function + number_Umin_function + number_Umax_function + number_kz_zv_function + number_GP_function + number_TP_function - 1;
      }
      else if (current_ekran.index_position < (number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function + number_urov_function + number_zop_function + number_Umin_function + number_Umax_function + number_kz_zv_function + number_GP_function + number_TP_function + number_UP_function + number_el_function))
      {
        if ((current_settings.configuration & (1<<EL_BIT_CONFIGURATION)) != 0) *found_new_index_tmp = 1;
        else current_ekran.index_position = number_general_function + number_on_off_function + number_ozt_function + number_mtz_function + number_P_3U0_function + number_tznp_function + number_urov_function + number_zop_function + number_Umin_function + number_Umax_function + number_kz_zv_function + number_GP_function + number_TP_function + number_UP_function - 1;
      }
    }
